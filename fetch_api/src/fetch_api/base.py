...
class Base(object):
    ...
    def go_forward(self, distance, speed=0.1):
        ...
        whlie self.message is NONE:
                rospy.sleep()
                start = copy.deepcopy(msg.pose)
        rate = rospy.Rate(10)
    ...
    def turn(self, angular_distance, speed=0.5):
        ...
        start = copy.deepcopy(msg.quaternion)
        ...
        while quaternion_to_yaw(msg.quaternion) != angular_distance:
            # TODO: you will probably need to do some math in this loop to check the CONDITION
